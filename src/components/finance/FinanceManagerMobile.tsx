...
export const FinanceManagerMobile: React.FC = () => {
    ...
    return (
        <div className="md:hidden min-h-screen bg-slate-50 dark:bg-[#151521] text-slate-900 dark:text-white pb-20">
            ...
            {/* Tabs */}
            <div className="px-4 py-3 sticky top-[53px] z-10 bg-slate-50 dark:bg-[#151521]">
                <div className="flex bg-white dark:bg-[#1e1e2d] p-1 rounded-xl overflow-x-auto no-scrollbar border border-slate-200 dark:border-transparent">
                    {tabs.map((tab) => (
                        <button
                            key={tab.key}
