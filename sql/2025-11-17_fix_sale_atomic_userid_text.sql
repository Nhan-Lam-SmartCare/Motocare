-- Fix sale_create_atomic: Change p_user_id from UUID back to TEXT
-- This fixes the "UNAUTHORIZED" error when calling the function
-- Date: 2025-11-17
...
BEGIN
  ...
  -- Insert sale (lowercase column names for compatibility)
