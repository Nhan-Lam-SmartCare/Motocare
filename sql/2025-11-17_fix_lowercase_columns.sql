-- Drop and recreate sale_create_atomic with LOWERCASE column names
-- Date: 2025-11-17
...
BEGIN
  ...
  WHILE v_index < v_items_count LOOP
    ...
    -- Insert inventory transaction with LOWERCASE column names
...
COMMENT ON FUNCTION public.sale_create_atomic IS 'Tạo hóa đơn và cập nhật tồn kho + giao dịch tiền mặt trong 1 transaction (atomic). Uses lowercase column names for inventory_transactions.';
