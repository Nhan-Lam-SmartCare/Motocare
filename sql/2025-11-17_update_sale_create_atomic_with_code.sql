-- Update sale_create_atomic to auto-generate sale_code
-- Date: 2025-11-17
...
BEGIN
  ...
  -- Note: sale_code will be auto-generated by trigger
  ...
  -- Cash transaction with lowercase column names - include type column
  -- Get the generated sale_code from the inserted row
...
COMMENT ON FUNCTION public.sale_create_atomic IS 'Tạo hóa đơn và cập nhật tồn kho + giao dịch tiền mặt trong 1 transaction (atomic). Auto-generates sale_code.';
