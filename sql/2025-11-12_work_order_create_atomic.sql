-- Atomic work order creation RPC: creates work order, decrements stock, inserts inventory transactions & cash transaction
-- Rollback entirely if any part lacks sufficient stock.
...
COMMENT ON FUNCTION public.work_order_create_atomic IS 'Tạo phiếu sửa chữa và cập nhật tồn kho + giao dịch tiền mặt trong 1 transaction (atomic).';
